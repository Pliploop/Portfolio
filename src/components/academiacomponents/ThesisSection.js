import {Academiatag, Tocitem} from '../academiacomponents/UnitComponents'
...
function ThesisSection() {
    ...
    return (
      <div className="absolute lg:w-2/3 md:w-[calc(100%-10rem)] w-[calc(100%-3rem)] h-56 flex flex-row justify-evenly lg:gap-16 gap-8 -mt-2">
        ...
        <div className="lg:w-1/2 w-full h-full flex flex-col justify-end content-start items-start">
          <div className="flex flex-col content-start gap-3 w-full h-full">
            ...
            <div className="flex flex-row gap-5 items-center justify-start">
              ...
              <a  href="/TFE.pdf" target="_blank" rel="noopener noreferrer" className=" rounded-full px-6 py-2 bg-white flex flex-row gap-3 active:bg-red-500 active:scale-95 active:text-white select-none border-[1px] border-red-500 hover:border-red-400 text-red-500 hover:text-red-600 transition-all duration-[20ms] items-center shadow-sm shadow-gray-400 group hover:bg-gray-100 cursor-pointer">
            ...
            <div className="flex flex-col mt-6 items-start gap-3">
              <div className="text-base font-inter text-blue-500 font-bold text-left mb-3">
                Table of contents
              </div>
              <Tocitem
                num={"1."}
