...
export function HeroSection() {
  return (
    <div className="flex flex-col align-top justify-between gap-20">
      <div className="w-full flex flex-row justify-between">
        <div className="w-[28%] h-[28%] aspect-square group">
          ...
          <div className="w-full h-full scale-95 border-white border-8 group-hover:scale-100 transition-all shadow-lg group-hover:shadow-gray-400 aspect-square rounded-full overflow-hidden">
            <img src={image} alt="me"></img>
          </div>

          
        </div>
        <div className=" grow ml-20 flex flex-col justify-between gap-5">
          <div className="w-full h-3/4">
            <h1 className="section-title mb-5">Julien Guinot, MSc</h1>
            <span className="text-sm text-gray-600 font-bold"> Welcome to my academic portfolio! </span> <span className="text-sm text-gray-600"> I'm a French-American double Masters graduate passionate about music and AI, and I believe research in those fields is my vocation. I'm aiming to undertake a Music Information Retrieval oriented PhD program in september 2023 to extend my understanding of music and research. I'm a self taught guitarist, bassist vocalist, pianist, producer and DJ of 7 years.</span>
            <br/>
            <br/>
            <span className="text-sm text-gray-600"> On this website you'll find my academic writings as well as music I've either made, arranged, performed or mixed and mastered. This is an academia-oriented portfolio, so for further info and projects you can check out <a href="https://julienguinot.com" className="text-blue-400 hover:text-blue-500 hover:font-bold">my website!</a></span>
...
const EducationSubSection = () => {
  return (
    <div className="h-auto w-1/4 px-10">
      ...
      <ul class="relative border-l border-gray-200 dark:border-gray-700 mt-3">
        <li class="mb-3 ml-4">
          ...
          <h3 class="text-xs font-semibold text-gray-900 dark:text-white mb-2">
            BSc Engineering
          </h3>
...
const ProfessionalSubsection = () => {
  return (
    <div className="h-auto w-1/4 px-10 ml-10">
      <div className="flex flex-row align-middle">
        <h2 className="font-mono text-lg font-semibold text-blue-400">
          {" "}
          Professional
...
const ContactLinks = () => {
  return (
    <div className="w-full grow flex gap-5 flex-row align-middle content-center justify-start p-5">
      <a  className="h-10 px-5 rounded-full bg-gradient-to-tr from-sky-300 to-teal-400 shadow-md border-gray-100 border-2 flex cursor-pointer hover:scale-105 transition-all hover:from-sky-400 hover:to-teal-500 text-white font-semibold active:scale-95">
        <span className="text-sm self-center align-middle font-mono">
          My Resume
        </span>
      </a>
