...
const AcademiaNav = () => {
  return (
    <nav class="bg-white backdrop-filter backdrop-blur-sm bg-opacity-70 px-10 py-5 sticky grow z-50 pt-5 top-0 left-0 border-b border-gray-200 mb-20 hidden lg:flex">
